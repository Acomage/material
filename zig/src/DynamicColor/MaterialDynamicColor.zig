...
pub const allMaterialDynamicColorsName: [45][]const u8 = .{
    "primary",
    "onPrimary",
    "primaryContainer",
    "onPrimaryContainer",
...
pub const allMaterialDynamicColors = struct {
    primary: [7]u8,
    onPrimary: [7]u8,
    primaryContainer: [7]u8,
    onPrimaryContainer: [7]u8,
    inversePrimary: [7]u8,
    primaryFixed: [7]u8,
    primaryFixedDim: [7]u8,
    onPrimaryFixed: [7]u8,
    onPrimaryFixedVariant: [7]u8,
    secondary: [7]u8,
    onSecondary: [7]u8,
    secondaryContainer: [7]u8,
    onSecondaryContainer: [7]u8,
    secondaryFixed: [7]u8,
    secondaryFixedDim: [7]u8,
    onSecondaryFixed: [7]u8,
    onSecondaryFixedVariant: [7]u8,
    tertiary: [7]u8,
    onTertiary: [7]u8,
    tertiaryContainer: [7]u8,
    onTertiaryContainer: [7]u8,
    tertiaryFixed: [7]u8,
    tertiaryFixedDim: [7]u8,
    onTertiaryFixed: [7]u8,
    onTertiaryFixedVariant: [7]u8,
    surface: [7]u8,
    surfaceDim: [7]u8,
    surfaceBright: [7]u8,
    surfaceContainerLowest: [7]u8,
    surfaceContainerLow: [7]u8,
    surfaceContainer: [7]u8,
    surfaceContainerHigh: [7]u8,
    surfaceContainerHighest: [7]u8,
    onSurface: [7]u8,
    inverseSurface: [7]u8,
    inverseOnSurface: [7]u8,
    shadow: [7]u8,
    scrim: [7]u8,
    onSurfaceVariant: [7]u8,
    outline: [7]u8,
    outlineVariant: [7]u8,
    @"error": [7]u8,
    onError: [7]u8,
    errorContainer: [7]u8,
    onErrorContainer: [7]u8,
};

pub const allMaterialDynamicColorsToneFn: [45]*const ToneFn = .{
    &primary,
    &onPrimary,
    &primaryContainer,
    &onPrimaryContainer,
...
pub const allMaterialDynamicColorsPalette: [45]Palette = .{
    Palette.primary,
    Palette.primary,
    Palette.primary,
    Palette.primary,
